...
CartItemModel _cartItemModelDeserialize(
  ...
  final object = CartItemModel(
    ...
    songId: reader.readString(offsets[1]),
  );
  return object;
}
...
extension CartItemModelQuerySortBy
  ...
  QueryBuilder<CartItemModel, CartItemModel, QAfterSortBy> sortBySongId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'songId', Sort.asc);
    });
  }

  QueryBuilder<CartItemModel, CartItemModel, QAfterSortBy> sortBySongIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CartItemModelQuerySortThenBy
  ...
  QueryBuilder<CartItemModel, CartItemModel, QAfterSortBy> thenBySongId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'songId', Sort.asc);
    });
  }

  QueryBuilder<CartItemModel, CartItemModel, QAfterSortBy> thenBySongIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'songId', Sort.desc);
    });
  }
...
extension CartItemModelQueryWhereDistinct
  ...
  QueryBuilder<CartItemModel, CartItemModel, QDistinct> distinctBySongId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension CartItemModelQueryProperty
  ...
  QueryBuilder<CartItemModel, String, QQueryOperations> songIdProperty() {
    return QueryBuilder.apply(this, (query) {
